...
class EditVehiclePage extends StatelessWidget {
  Vehicle vehicle;
  EditVehiclePage({super.key, required this.vehicle});
  ...
  Widget build(BuildContext context) {
    ...
    vehicleBrandController.text = vehicle.vehicleBrand!;
    vehicleManufacturerController.text = vehicle.vehicleManufacturer!;
    vehicleTypeController.text = vehicle.vehicleType!;
    vehicleRateController.text = vehicle.vehicleRentRate.toString();
    imageLocationController.text = vehicle.image!;
          ...
          children: [
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                    border: OutlineInputBorder(), labelText: 'Image Location'),
              ),
            ),
            const SizedBox(
              height: 30,
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (vehicleNameController.text.isNotEmpty &&
                    ...
                    double? rate = double.tryParse(vehicleRateController.text);
                    ...
                    String url = '${Env.prefix}/edit_vehicle/';
